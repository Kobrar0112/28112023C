...
namespace ConsoleApp2
{
    ...
    public class TypingTest
    {
        ...
        public void StartTest()
        {
            ...
            textToType = "Марка Exeed была основана 14 сентября 2017 года. Первым автомобилем под брендом Exeed является Exeed LX, который был представлен на Пекинском международном автосалоне 29 апреля 2018 года.";
